      ...
      <div className="mx-auto max-w-6xl px-6 py-10 md:py-14">
        ...
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-pretty leading-relaxed text-ink-700">
            Answer these guided questions in plain language. The AI extracts only the facts you provide —
            it will never invent details. One question at a time.
          </p>
        </div>
        ...
        <ol className="mt-8 flex flex-wrap items-center gap-x-3 gap-y-2 text-sm">
          {([
            ...
            { n: 2, label: "Describe problem", done: true,  active: false },
            { n: 3, label: "AI interview",     done: false, active: true  },
